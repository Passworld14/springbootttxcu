    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        ...
        <el-row class="ad"
          ...
          <el-form-item>
            ...
            <el-button v-if="isAuth('gonggaoxinxi', '新增') && contents.btnAdAllIcon == 0" type="success"
            ...
            <el-button v-if="isAuth('gonggaoxinxi', '删除') && contents.btnAdAllIcon == 0 && contents.tableSelection"
              :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandler()">{{ contents.btnAdAllFont
                == 1 ? '删除' : '' }}</el-button>
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
          ...
          v-if="isAuth('gonggaoxinxi', '查看')" :data="dataList" v-loading="dataListLoading"
          ...
          <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="fabuzhe"
            :header-align="contents.tableAlign" label="发布者">
            <template slot-scope="scope">
              {{ scope.row.fabuzhe }}
            </template>
          </el-table-column>
          <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="fabushijian"
