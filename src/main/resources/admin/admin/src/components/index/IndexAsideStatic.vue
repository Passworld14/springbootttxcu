			...
			<div v-for="item in menuList" :key="item.roleName" v-if="role == item.roleName" class="menulist-item">
				<div class="menulistImg" v-if="false && 2 == 2">
					<el-image
						...
						v-if="'https://pic.imgdb.cn/item/66e7c55bd9c307b7e9e995c1.jpg'"
						src="https://pic.imgdb.cn/item/66e7c55bd9c307b7e9e995c1.jpg" fit="cover" />
				</div>
				<el-menu :mode="2 == 1 ? 'horizontal' : 'vertical'" :unique-opened="true" class="el-menu-demo" default-active="0">
					<el-menu-item index="0" icon="el-icon-s-home" @click="menuHandler('')"><i v-if="true"
...
.index-aside {
	...
	.menulist-item {
		...
		background: url(https://pic.imgdb.cn/item/66e7c55bd9c307b7e9e995c1.jpg);
		// background: #0f67d2 !important;
	...
	.el-menu-demo {
		...
		&>.el-menu-item {
			...
			&.is-active {
				background-color: rgb(58, 73, 102) !important;
				text-align: center;
			}
		...
		& /deep/ .el-submenu__title {
			...
			// background-color: rgb(28, 18, 4);
			// box-shadow: 0 0 6px rgba(254, 252, 252, 0);
			box-sizing: initial;
			display: flex;
			align-items: center;
			justify-content: flex-start;
		...
		& /deep/ .el-menu.el-menu--inline {
			...
			.el-menu-item {
				...
				background-color: rgb(114, 145, 205) !important;
