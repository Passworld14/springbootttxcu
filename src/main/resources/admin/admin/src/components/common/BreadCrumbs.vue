<template>
  ...
  <el-breadcrumb class="app-breadcrumb" separator="/"
    style="height:40px;backgroundColor:rgb(255, 255, 255);borderRadius:0; padding:0px 20px 0px 20px;boxShadow:0 2.8px 2.2px rgba(0,0,0,0.258);borderWidth:0;borderStyle: solid ;">
